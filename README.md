...
<p>This app lets the user create and delete tesks. This is a hybrid app that is built to be used as a web application, android appication, windows application or iOS application</p>
